...
int _categoryEstimateSize(
  ...
  bytesCount += 3 + object.keywordList.length * 3;
  {
    for (var i = 0; i < object.keywordList.length; i++) {
      final value = object.keywordList[i];
...
void _categorySerialize(
  ...
  writer.writeStringList(offsets[3], object.keywordList);
  writer.writeString(offsets[4], object.keywords);
...
Category _categoryDeserialize(
  ...
  object.id = id;
  object.keywords = reader.readString(offsets[4]);
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition>
      keywordListElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'keywordList',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition>
      keywordListElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'keywordList',
        value: value,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition>
      keywordListElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'keywordList',
        wildcard: pattern,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition>
      keywordListLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordListIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'keywordList',
        0,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> keywordsMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByKeywords() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'keywords', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByKeywordsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByKeywords() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'keywords', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByKeywordsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'keywords', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByKeywordList() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'keywordList');
    });
  }
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, List<String>, QQueryOperations> keywordListProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'keywordList');
    });
  }

  QueryBuilder<Category, String, QQueryOperations> keywordsProperty() {
    return QueryBuilder.apply(this, (query) {
